...
public class PollDAOImpl extends BaseDAOImpl implements PollDAO {
	public void add(Poll poll) {
		dml("insert.poll", new Object[] { poll.getQuestion(), poll.getAnswer1(), poll.getAnswer2(), poll.getAnswer3(), poll.getAnswer4(), poll.getAnswer5(), Boolean.valueOf(poll.isEnabled()) });
	}

	public void update(Poll poll) {
		dml("update.poll", new Object[] { poll.getQuestion(), poll.getAnswer1(), poll.getAnswer2(), poll.getAnswer3(), poll.getAnswer4(), poll.getAnswer5(), Boolean.valueOf(poll.isEnabled()), poll.getPid() });
	}
